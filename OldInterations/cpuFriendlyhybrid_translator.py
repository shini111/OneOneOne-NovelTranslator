...
class CPUFriendlyHybridTranslator:
    def __init__(self):
        ...
        if self.device == "cuda":
            ...
            print("⚠️ Using CPU - models will be slower but still work")
        ...
        # Available local LLM models (CPU-friendly versions)
        self.available_llms = {
            "qwen-small": {
                "model": "Qwen/Qwen2.5-1.5B-Instruct",
                "size": "1.5B parameters",
                "good_for": "Fast, good for Asian languages",
                "ram_needed": "3GB"
            },
            "qwen-chat": {
            ...
            "microsoft-phi": {
                ...
                "good_for": "General purpose, efficient",
                "ram_needed": "5GB"
            }
        }
    ...
    def show_available_llms(self):
        ...
        print("\n🤖 Available Local LLM Models (CPU-Friendly):")
        print("=" * 70)
    ...
    def load_llm_model(self, model_choice="qwen-small"):
        """Load local LLM model without quantization"""
        ...
        try:
            ...
            # Load model WITHOUT quantization (CPU-friendly)
            ...
            print("💡 Try a smaller model or ensure you have enough RAM")
            return False
...
Refined translation:"""
    ...
    def hybrid_translate(self, text, source_lang, target_lang, context="", use_llm=True):
        ...
        print(f"🔄 Hybrid translation: {source_lang} → {target_lang} (Device: {self.device})")
    ...
    # Document reading methods (keeping the same as before)
    ...
    def translate_document(self, file_path, source_lang, target_lang, context="", use_llm=True):
        ...
        print(f"\n🚀 CPU-Friendly Hybrid Document Translation")
        ...
        # Save
        method = f"hybrid_{self.device}" if (use_llm and self.llm_model) else f"basic_{self.device}"
...
def main():
    """Main interface for CPU-friendly hybrid translation"""
    translator = CPUFriendlyHybridTranslator()
    
    print("🚀 CPU-Friendly Hybrid Translation System")
    print("=" * 60)
    print("🎯 Works on both CPU and GPU (RTX 4060 supported)")
    print("🤖 No quantization required - pure PyTorch")
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("- 'qwen-small' (fast, good balance)")
            print("- 'qwen-chat' (better quality)")
            print("- 'microsoft-phi' (general purpose)")
